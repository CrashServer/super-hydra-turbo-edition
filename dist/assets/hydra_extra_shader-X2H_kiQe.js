setFunction({name:"sepia",type:"color",inputs:[{name:"amount",type:"float",default:1}],glsl:`
...
`});setFunction({name:"levels",type:"color",inputs:[{name:"levels",type:"float",default:3},{name:"amount",type:"float",default:1}],glsl:`
  vec3 le = floor(_c0.rgb * levels) / levels;
  return vec4(amount * le + (1.0 - amount) * _c0.rgb, _c0.a);
`});setFunction({name:"monotone",type:"color",inputs:[{name:"levels",type:"float",default:3},{name:"hue",type:"float",default:.6},{name:"amount",type:"float",default:1}],glsl:`
...
`});setFunction({name:"grarose",type:"color",inputs:[{name:"amount",type:"float",default:1}],glsl:`
...
`});setFunction({name:"grawave",type:"color",inputs:[{name:"amount",type:"float",default:1}],glsl:`
  const float d3 = 1.0 / 3.0;
  float gray = d3 * (_c0.r + _c0.g + _c0.b);
  vec3 co;
  if (gray < 0.0) {
  ...
  return vec4(amount * clamp(co, 0.0, 1.0) + (1.0 - amount) * _c0.rgb, _c0.a);
`});setFunction({name:"graua",type:"color",inputs:[{name:"amount",type:"float",default:1}],glsl:`
  vec3 co = vec3(0.0);
  const float d3 = 1.0 / 3.0;
  float gray = d3 * (_c0.r + _c0.g + _c0.b);
  ...
  return vec4(amount * clamp(co, 0.0, 1.0) + (1.0 - amount) * _c0.rgb, _c0.a);
`});setFunction({name:"colcross",type:"combine",inputs:[{name:"amount",type:"float",default:1}],glsl:`
vec3 cc = cross(_c0.rgb, _c1.rgb);
return vec4(amount * cc + (1.0 - amount) * _c0.rgb, _c0.a);
`});setFunction({name:"coldot",type:"combine",inputs:[{name:"amount",type:"float",default:1}],glsl:`
vec3 cc = vec3(dot(_c0.rgb, _c1.rgb),
               dot(_c0.rgb, _c1.brg),
               dot(_c0.rgb, _c1.gbr));
return vec4(amount * cc + (1.0 - amount) * _c0.rgb, _c0.a);
`});setFunction({name:"colboost",type:"combine",inputs:[{name:"amount",type:"float",default:1}],glsl:`
vec3 cc = cross(_c0.rgb, _c1.rgb);
cc = normalize(_c0.rgb);
return vec4(amount * cc + (1.0 - amount) * _c0.rgb, _c0.a);
`});setFunction({name:"colreflect",type:"combine",inputs:[{type:"float",name:"amount",default:1}],glsl:`
vec3 cc = cross(_c0.rgb, normalize(_c1.rgb));
return vec4(amount * cc + (1.0 - amount) * _c0.rgb, _c0.a);
`});setFunction({name:"hsvshift",type:"color",inputs:[{name:"hue",type:"float",default:0},{name:"saturation",type:"float",default:1},{name:"value",type:"float",default:1}],glsl:`
  vec3 hsv = _rgbToHsv(_c0.rgb);
  hsv.x += hue;
  hsv.y *= saturation;
  hsv.z *= value;
  return vec4(_hsvToRgb(hsv), _c0.a);
`});setFunction({name:"ifpos",type:"combine",inputs:[{name:"value",type:"float",default:1}],glsl:`
    return value < 0.0 ? _c0 : _c1;
  `});setFunction({name:"ifeven",type:"combine",inputs:[{name:"value",type:"float",default:0},{name:"eps",type:"float",default:.01}],glsl:`
    return abs(mod(floor(value), 2.0)) < eps ? _c0 : _c1;
  `});setFunction({name:"ifzero",type:"combine",inputs:[{name:"value",type:"float",default:0},{name:"eps",type:"float",default:.1}],glsl:`
      return abs(value) < eps ? _c0 : _c1;
    `});setFunction({name:"splitview",type:"combine",inputs:[{name:"where",type:"float",default:.5}],glsl:`
    return gl_FragCoord.x/resolution.x > where ? _c0 : _c1;
  `});setFunction({name:"splitviewh",type:"combine",inputs:[{name:"where",type:"float",default:.5}],glsl:`
    return gl_FragCoord.y/resolution.y > where ? _c0 : _c1;
  `});setFunction({name:"whitenoise",type:"src",inputs:[{name:"size",type:"float",default:10},{name:"dynamic",type:"float",default:0}],glsl:`
  ...
  return vec4(d, d, d, 1);
`});setFunction({name:"colornoise",type:"src",inputs:[{name:"size",type:"float",default:10},{name:"dynamic",type:"float",default:0}],glsl:`
  highp float rr;
  highp float gg;
  highp float bb;
  // see: http://byteblacksmith.com/improvements-to-the-canonical-one-liner-glsl-rand-for-opengl-es-2-0/
...
`});setFunction({name:"unoise",type:"src",inputs:[{name:"scale",type:"float",default:10},{name:"offset",type:"float",default:.1}],glsl:`
  float noi = _noise(vec3(_st*scale, offset*time));
  noi = 0.5 + 0.5 * noi;
  return vec4(noi, noi, noi, 1.0);
`});setFunction({name:"turb",type:"src",inputs:[{name:"scale",type:"float",default:10},{name:"offset",type:"float",default:.1},{name:"octaves",type:"float",default:3}],glsl:`
...
`});setFunction({name:"uturb",type:"src",inputs:[{name:"scale",type:"float",default:10},{name:"offset",type:"float",default:.1},{name:"octaves",type:"float",default:3}],glsl:`
  int on = int(abs(octaves));
  float fr = fract(octaves);
  vec2 pos = scale * _st;
  float sc = 1.0;
  ...
  fbm = 0.5 + 0.5 * fbm;
  return vec4(fbm, fbm, fbm, 1.0);
`});setFunction({name:"warp",type:"src",inputs:[{name:"scalei",type:"float",default:10},{name:"offset",type:"float",default:.1},{name:"octaves",type:"float",default:2},{name:"octavesinner",type:"float",default:3},{name:"scale",type:"float",default:1}],glsl:`
  ...
  fbm += fr * sc * _noise(vec3(pos, offset * time));
  return vec4(fbm, fbm, fbm, 1.0);
`});setFunction({name:"cwarp",type:"src",inputs:[{name:"scalei",type:"float",default:10},{name:"offset",type:"float",default:.1},{name:"octaves",type:"float",default:2},{name:"octavesinner",type:"float",default:3},{name:"scale",type:"float",default:1},{name:"focus",type:"float",default:.5}],glsl:`
  ...
  return vec4(fbm, fbm, fbm, 1.0);
`});setFunction({name:"ncontour",type:"src",inputs:[{name:"thresh",type:"float",default:.5},{name:"smooth",type:"float",default:.1},{name:"octaves",type:"int",default:3},{name:"scale",type:"float",default:5},{name:"speed",type:"float",default:.5},{name:"step",type:"float",default:2}],glsl:`
  vec2 st = _st - 0.5;
...
`});setFunction({name:"pulse",type:"src",inputs:[{name:"edge",type:"float",default:.5},{name:"width",type:"float",default:.05},{name:"epsilon",type:"float",default:.001}],glsl:`
    ...
    float d = d0-d1;
    return vec4(d, d, d, 1);
`});setFunction({name:"pulsetrain",type:"src",inputs:[{name:"train",type:"float",default:3},{name:"edge",type:"float",default:.5},{name:"width",type:"float",default:.05},{name:"epsilon",type:"float",default:.001}],glsl:`
    float ea = abs(epsilon);
    float wa = abs(width);
    float xp = _st.x;
    float d = 0.0;
    ...
    return vec4(d, d, d, 1);
`});setFunction({name:"hextile",type:"src",inputs:[{name:"tiles",type:"float",default:10}],glsl:`
  ...
  return vec4(d, d, d, 1);
`});setFunction({name:"checker",type:"src",inputs:[{name:"repeats",type:"float",default:10}],glsl:`
  vec2 c = floor(repeats * (_st - 0.5));
  float d = sign(mod(c.x + c.y, 2.0));
  return vec4(d, d, d, 1);
`});setFunction({name:"concentric",type:"src",inputs:[{name:"scale",type:"float",default:100},{name:"centerX",type:"float",default:.5},{name:"centerY",type:"float",default:.5}],glsl:`
   float d = sin(scale*distance(_st, vec2(centerX, centerY)));
   return vec4(d, d, d, 1);
`});setFunction({name:"spiral",type:"src",inputs:[{name:"a",type:"float",default:1},{name:"b",type:"float",default:5},{name:"thickness",type:"float",default:.1}],glsl:`
    ...
    return vec4(d, d, d, 1);
`});setFunction({name:"brick",type:"src",inputs:[{name:"width",type:"float",default:.25},{name:"height",type:"float",default:.08},{name:"gap",type:"float",default:.01}],glsl:`
  vec2 p = _st-0.5;
  ...
  float d = w*h;
  return vec4(d, d, d, 1);
`});setFunction({name:"wave",type:"src",inputs:[{name:"time",type:"float",default:0},{name:"frequ",type:"float",default:10},{name:"loops",type:"float",default:3},{name:"thick",type:"float",default:.025}],glsl:`
  const float eps = 0.001;
  float x = _st.x - time;
  float y = _st.y - 0.5;
  float scale = 0.25;
  ...
  return vec4(d, d, d, 1);
`});setFunction({name:"lissa",type:"src",inputs:[{name:"time",type:"float",default:0},{name:"frequ",type:"float",default:10},{name:"loops",type:"float",default:3},{name:"thick",type:"float",default:.025}],glsl:`
  const float eps = 0.001;
  _st -= 0.5;
  vec2 pol = vec2(
    atan(_st.y, _st.x),
  ...
  float d = smoothstep(0.0, eps, y) - smoothstep(thick, thick+eps, y);
  return vec4(d, d, d, 1);
`});setFunction({name:"dither",type:"color",inputs:[],glsl:`
...
`});setFunction({name:"dither2",type:"color",inputs:[],glsl:`
  float lum = 0.299 * _c0.r + 0.587 * _c0.g + 0.114 * _c0.b;
  ...
  return vec4(
    ...
    step(bayer, _c0.b),
    _c0.a);
`});setFunction({name:"dither4",type:"color",inputs:[],glsl:`
  int x = int(mod(gl_FragCoord.x, 4.0));
  int y = int(mod(gl_FragCoord.y, 4.0));
  ...
  return vec4(
    ...
    step(bayer, _c0.b),
    _c0.a);
`});setFunction({name:"ditherrnd",type:"color",inputs:[],glsl:`
  float lum = 0.299 * _c0.r + 0.587 * _c0.g + 0.114 * _c0.b;
  // see: http://byteblacksmith.com/improvements-to-the-canonical-one-liner-glsl-rand-for-opengl-es-2-0/
  const highp float a = 12.9898;
  const highp float b = 78.233;
...
`});setFunction({name:"ditherrndcolor",type:"color",inputs:[],glsl:`
  float lum = 0.299 * _c0.r + 0.587 * _c0.g + 0.114 * _c0.b;
  // see: http://byteblacksmith.com/improvements-to-the-canonical-one-liner-glsl-rand-for-opengl-es-2-0/
  const highp float a = 12.9898;
  const highp float b = 78.233;
  ...
  return vec4(
    ...
    step(tresh, _c0.b),
    _c0.a);
`});setFunction({name:"erode",type:"color",inputs:[],glsl:`
...
`});setFunction({name:"dilate",type:"color",inputs:[],glsl:`
  vec3 outputColor = vec3(0.0);
	...
	outputColor = max(outputColor, texture2D(tex0, (gl_FragCoord.xy + vec2( 1, -1))/resolution.xy).rgb);
  return vec4(outputColor, _c0.a);
`});setFunction({name:"blur",type:"color",inputs:[],glsl:`
  vec3 outputColor;
	...
	outputColor += 0.077847 * texture2D(tex0, (gl_FragCoord.xy + vec2( 1, -1))/resolution.xy).rgb;
  return vec4(outputColor, _c0.a);
`});setFunction({name:"blurmore",type:"color",inputs:[],glsl:`
  vec3 outputColor;
  ...
  outputColor += 0.003765 * texture2D(tex0, (gl_FragCoord.xy + vec2( 2,  2))/resolution.xy).rgb;
  return vec4(outputColor, _c0.a);
`});setFunction({name:"edge",type:"color",inputs:[],glsl:`
  vec3 outputColor;
	...
	outputColor += -1.0/8.0 * texture2D(tex0, (gl_FragCoord.xy + vec2( 1, -1))/resolution.xy).rgb;
  return vec4(outputColor, _c0.a);
`});setFunction({name:"sobelx",type:"color",inputs:[],glsl:`
  vec3 outputColor;
	...
	outputColor +=  1.0 * texture2D(tex0, (gl_FragCoord.xy + vec2( 1, -1))/resolution.xy).rgb;
  return vec4(outputColor, _c0.a);
`});setFunction({name:"sobely",type:"color",inputs:[],glsl:`
  vec3 outputColor;
  outputColor  = -1.0 * texture2D(tex0, (gl_FragCoord.xy + vec2(-1,  1))/resolution.xy).rgb;
	...
	outputColor +=  1.0 * texture2D(tex0, (gl_FragCoord.xy + vec2( 1, -1))/resolution.xy).rgb;
  return vec4(outputColor, _c0.a);
`});setFunction({name:"sharpen",type:"color",inputs:[],glsl:`
  vec3 outputColor;
	...
	outputColor += -1.0 * texture2D(tex0, (gl_FragCoord.xy + vec2( 0, -1))/resolution.xy).rgb;
  return vec4(outputColor, _c0.a);
`});setFunction({name:"emboss",type:"color",inputs:[],glsl:`
  vec3 outputColor;
	...
	outputColor +=  2.0 * texture2D(tex0, (gl_FragCoord.xy + vec2( 1, -1))/resolution.xy).rgb;
  return vec4(outputColor, _c0.a);
`});setFunction({name:"altline",type:"color",inputs:[{name:"width",type:"float",default:1}],glsl:`
...
`});setFunction({name:"pxsort",type:"color",inputs:[{name:"threshold",type:"float",default:.2},{name:"frame",type:"int",default:0},{name:"dirX",type:"float",default:1},{name:"dirY",type:"float",default:0}],glsl:`
...
`});setFunction({name:"pysort",type:"color",inputs:[{name:"threshold",type:"float",default:.2},{name:"frame",type:"int",default:0},{name:"dirX",type:"float",default:0},{name:"dirY",type:"float",default:1}],glsl:`
  vec2 uv2 = gl_FragCoord.xy/resolution.xy;
  float fParity = mod(float(frame), 2.) * 2. - 1.;
...
`});setFunction({name:"blinking",type:"src",inputs:[{name:"tiles",type:"float",default:5},{name:"scale",type:"float",default:5},{name:"speed",type:"float",default:.5},{name:"phase",type:"float",default:.03}],glsl:`
...
`});setFunction({name:"blobs",type:"src",inputs:[{name:"speed",type:"float",default:.1},{name:"tresh",type:"float",default:.2},{name:"soft",type:"float",default:.05}],glsl:`
    float edge   = 0.2;
    float border = 0.05;
    float vv = 0.5;
    vec2 st = _st-0.5;
...
`});setFunction({name:"concentric2",type:"src",inputs:[{name:"base",type:"float",default:5},{name:"octaves",type:"float",default:2},{name:"ampscale",type:"float",default:.5},{name:"speed",type:"float",default:1}],glsl:`
  ...
  d += ampscale*(0.5*sin(r*octaves+speed*time) + 0.5);
  return vec4(d, d, d, 1);
`});setFunction({name:"phasenoise",type:"src",inputs:[{name:"base",type:"float",default:0},{name:"range",type:"float",default:.1},{name:"scale",type:"float",default:5},{name:"speed",type:"float",default:.5},{name:"phase",type:"float",default:.03}],glsl:`
  ...
  return vec4(_hsvToRgb(vec3(h, s, v)), 1.0);
`});setFunction({name:"sdfmove",type:"src",inputs:[{name:"speed1",type:"float",default:.73},{name:"speed2",type:"float",default:1},{name:"speed3",type:"float",default:-.53}],glsl:`
  vec2 st = _st;
  ...
  d = pow(d, 0.4);
  return vec4(d, d, d, 1);
`});setFunction({name:"smoothsun",type:"src",inputs:[{name:"threshold",type:"float",default:.3},{name:"border",type:"float",default:.2},{name:"speed",type:"float",default:1},{name:"ampscale",type:"float",default:.5}],glsl:`
  ...
  return vec4(d, d, d, 1);
`});setFunction({name:"invtile",type:"coord",inputs:[{name:"amount",type:"float",default:1}],glsl:`
  vec2 xy = _st - vec2(0.5);
  return mix(abs(xy), exp(abs(xy)), amount) + vec2(0.5);
`});setFunction({name:"invsqrt",type:"coord",inputs:[{name:"amount",type:"float",default:.5}],glsl:`
  vec2 xy = _st - vec2(0.5);
  xy = inversesqrt(abs(xy)+vec2(amount));
  return xy + vec2(0.5);
`});setFunction({name:"abslog",type:"coord",inputs:[{name:"amount",type:"float",default:1}],glsl:`
  vec2 xy = _st - vec2(0.5);
  xy.x = log(abs(xy.x)+amount);
  xy.y = log(abs(xy.y)+amount);
  xy += 0.5;
  return xy;
`});setFunction({name:"swave",type:"coord",inputs:[{name:"amount",type:"float",default:1}],glsl:`
  vec2 xy = _st - vec2(0.5);
  xy = mix(xy.xx, xy.yy, amount*dot(xy, xy.yx));
  return xy + vec2(0.5);
`});setFunction({name:"centermag",type:"coord",inputs:[{name:"r",type:"float",default:.4},{name:"h",type:"float",default:.2},{name:"cx",type:"float",default:0},{name:"cy",type:"float",default:0}],glsl:`
  vec2 xy = _st - vec2(cx+0.5, cy+0.5);
  h = r + h;
  float hr = r * sqrt(1.0 - ((r - h) / r) * ((r - h) / r));
  float rr = length(xy);
  return (rr < hr ? xy * (r - h) / sqrt(r * r - rr * rr) : xy) + vec2(cx+0.5, cy+0.5);
`});setFunction({name:"squ",type:"src",inputs:[{type:"float",name:"frequency",default:10},{type:"float",name:"speed",default:.1}],glsl:`
  float d = floor(0.5+fract((_st.x + time * speed) * frequency));
  return vec4(d, d, d, 1.0);
`});setFunction({name:"usin",type:"src",inputs:[{type:"float",name:"frequency",default:10},{type:"float",name:"speed",default:.1}],glsl:`
  float d = 0.5+0.5*sin((_st.x + time * speed) * frequency * 6.283185307179586);
  return vec4(d, d, d, 1.0);
`});setFunction({name:"saw",type:"src",inputs:[{type:"float",name:"frequency",default:10},{type:"float",name:"speed",default:.1}],glsl:`
  float d = fract((_st.x + time * speed) * frequency);
  return vec4(d, d, d, 1.0);
`});setFunction({name:"harmonic",type:"src",inputs:[{type:"float",name:"frequency",default:10},{type:"float",name:"speed",default:.1},{type:"float",name:"phase1",default:0},{type:"float",name:"phase2",default:0}],glsl:`
  ...
  return vec4(d, d, d, 1.0);
`});setFunction({name:"tri",type:"src",inputs:[{type:"float",name:"frequency",default:10},{type:"float",name:"speed",default:.1}],glsl:`
  float c = abs(mod(1.0+(_st.x + time * speed) * 2.0 * frequency, 2.0) - 1.0);
 return vec4(c, c, c, 1.0);
`});setFunction({name:"rsqu",type:"src",inputs:[{type:"float",name:"frequency",default:10},{type:"float",name:"speed",default:.1}],glsl:`
  float d = floor(0.5+fract((distance(_st, vec2(0.5,0.5)) + time * speed) * frequency));
  return vec4(d, d, d, 1.0);
`});setFunction({name:"rusin",type:"src",inputs:[{type:"float",name:"frequency",default:10},{type:"float",name:"speed",default:.1}],glsl:`
  float d = 0.5+0.5*sin((distance(_st, vec2(0.5,0.5)) + time * speed) * frequency * 6.283185307179586);
  return vec4(d, d, d, 1.0);
`});setFunction({name:"rsaw",type:"src",inputs:[{type:"float",name:"frequency",default:10},{type:"float",name:"speed",default:.1}],glsl:`
  float d = fract((distance(_st, vec2(0.5,0.5)) + time * speed) * frequency);
  return vec4(d, d, d, 1.0);
`});setFunction({name:"rharmonic",type:"src",inputs:[{type:"float",name:"frequency",default:10},{type:"float",name:"speed",default:.1},{type:"float",name:"phase1",default:0},{type:"float",name:"phase2",default:0}],glsl:`
  ...
  float d = 0.5 * (0.5714285714285714 * d0 + 0.2857142857142857 * d1 + 0.2857142857142857 * d2) + 0.5;
  return vec4(d, d, d, 1.0);
`});setFunction({name:"rtri",type:"src",inputs:[{type:"float",name:"frequency",default:10},{type:"float",name:"speed",default:.1}],glsl:`
  float c = abs(mod(1.0+(distance(_st, vec2(0.5,0.5)) + time * speed) * 2.0 * frequency, 2.0) - 1.0);
  return vec4(c, c, c, 1.0);
`});setFunction({name:"stripes",type:"src",inputs:[{type:"float",name:"frequency",default:10},{type:"float",name:"speed",default:1}],glsl:`
  // float d = floor((_st.x + time * speed) * frequency) / frequency;
  float d = fract(floor(_st.x * frequency) / frequency + time * speed);
  return vec4(d, d, d, 1.0);
`});setFunction({name:"rstripes",type:"src",inputs:[{type:"float",name:"frequency",default:10},{type:"float",name:"speed",default:1}],glsl:`
  // float d = floor((_st.x + time * speed) * frequency) / frequency;
  float d = fract(floor(distance(_st, vec2(0.5, 0.5)) * frequency) / frequency + time * speed);
  return vec4(d, d, d, 1.0);
`});setFunction({name:"polar",type:"coord",inputs:[{name:"radius",type:"float",default:1},{name:"angle",type:"float",default:1},{name:"centerX",type:"float",default:.5},{name:"centerY",type:"float",default:.5}],glsl:`
